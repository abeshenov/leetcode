...
16. Guess Number Higher or Lower
  [link:src/main/kotlin/guessNumberHigherOrLower.kt[Kotlin]]

17. Rectangle Area
  [link:src/main/kotlin/rectangleArea.kt[Kotlin]]

18. Ugly Number
  [link:src/main/kotlin/uglyNumber.kt[Kotlin]]
...
22. Perfect Squares
  [link:src/main/kotlin/perfectSquares.kt[Kotlin]]

23. Valid Sudoku
  [link:src/main/kotlin/validSudoku.kt[Kotlin]]
